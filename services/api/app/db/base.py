...
class Publication(Base):
    ...
    publication_method: Mapped[str | None] = mapped_column(String(40))
    confirmed_by: Mapped[UUID | None] = mapped_column(ForeignKey("users.id"))
    confirmed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
    external_url: Mapped[str | None] = mapped_column(Text)
    external_post_id: Mapped[str | None] = mapped_column(String(240))
    confirmation_evidence_json: Mapped[object | None] = mapped_column(JSON)
