...
const plans = [
  ["Free", "для личного теста", "1 проект, ограниченные AI-лимиты, ручные публикации"],
  ["Start", "для пилота", "несколько проектов, базовая расшифровка и расписание"],
      ...
      <section className="mx-auto grid max-w-6xl gap-6 px-4 py-10">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-base leading-7 text-muted">
            ...
            юридических условий и production-проверок.
          </p>
        </div>
        ...
        <div className="grid gap-4 lg:grid-cols-[1fr_auto]">
          <Card className="grid gap-3">
            ...
            <p className="text-sm leading-6 text-muted">
              До live billing нужно подтвердить провайдера оплаты, юридическое лицо, чеки, возвраты, отмену подписки,
              privacy/offer документы, RLS и backup restore drill.
            </p>
          </Card>
