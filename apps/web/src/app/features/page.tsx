...
const features = [
  ...
  ["Контент-студия", "Факты, голос, медиа, locked facts, мастер-текст и версии живут в одном материале.", FileCheck2],
  ["AI-редактура", "Подбор примеров, сборка текста, хуки, рейтинги и quality-check идут через provider interface.", Bot],
  ["Медиа", "Фото, видео и голосовые заметки привязываются к материалу и проходят через S3-хранилище.", ImageUp],
  ["Публикации", "Telegram, MAX, Instagram, webhook и manual export имеют отдельные статусы и retry/evidence.", RadioTower],
] as const;
