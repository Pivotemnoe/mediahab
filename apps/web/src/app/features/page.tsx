...
const features = [
  ...
  ["Идеи для постов · пилот", "Если тема не складывается, получите пять разных заходов по проекту и рубрике, выерите один и сразу дополните его голосом или текстом.", Lightbulb],
