import { BookOpenCheck, Boxes, FileCheck2, ImageUp, Lightbulb, Mic, SlidersHorizontal } from "lucide-react";
...
const features = [
  ...
  ["Идеи для постов · пилот", "Если тема не складывается, получите пять разных заходов по проекту и рубрике, выберите один и сразу дополните его голосом или текстом.", Lightbulb],
