...
def main() -> int:
    ...
    required_paths = {
        ...
        "/api/v1/workspaces/{workspace_id}/ideas/capability",
        "/api/v1/workspaces/{workspace_id}/ideas/generate",
        "/api/v1/workspaces/{workspace_id}/ideas/transcribe-topic",
        "/api/v1/workspaces/{workspace_id}/checkout",
        "/api/v1/workspaces/{workspace_id}/subscription/cancel",
        "/api/v1/admin/workspaces/{workspace_id}/assign-plan",
