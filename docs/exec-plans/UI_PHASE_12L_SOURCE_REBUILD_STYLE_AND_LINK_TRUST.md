...
- Local results: backend `165/165`; editorial surface `14/14`; AI examples pipeline `14/14`; TypeScript and Web lint pass; UI hardening passes; production Web build renders `35/35` pages; compileall and `git diff --check` pass.
